...
export const adminClubs = [
  ...
  { id: '#CL002', name: '러닝 동호회', status: '대기', category: '운동/스포츠', owner: '이영희', members: '8/15명', reports: 0, growth: '+2%' },
  { id: '#CL003', name: '독서 모임', status: '승인', category: '스터디', owner: '박민지', members: '25/30명', reports: 1, growth: '+12%' },
  { id: '#CL004', name: '요가 클래스', status: '중지', category: '운동/스포츠', owner: '최수진', members: '0/10명', reports: 3, growth: '-5%' },
];

export const adminPosts = [
  { id: '#1234', author: '김지현', category: '일상', title: '대학가 주변 조용한 동네카페', reports: 2, status: '노출', createdAt: '2026.04.26' },
  { id: '#1235', author: '이도윤', category: '질문', title: '동네 병원 추천해주세요', reports: 0, status: '노출', createdAt: '2026.04.26' },
  { id: '#1236', author: '박소연', category: '정보', title: '주차장 위치 안내', reports: 1, status: '숨김', createdAt: '2026.04.25' },
  { id: '#1237', author: '한경민', category: '댓글', title: '스팸 댓글 신고 접수', reports: 5, status: '대기', createdAt: '2026.04.25' },
];
...
export const auditLogs = [
  { time: '14:32', actor: 'admin@linkit', action: "회원 '한경민' 정지 처리", result: '성공' },
